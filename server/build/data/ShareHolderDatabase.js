...
class ShareHolderDatabase extends BaseDatabase_1.BaseDatabase {
    constructor() {
        ...
        this.createShareholderDataBase = (name, lastName, participation) => __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield BaseDatabase_1.BaseDatabase.connection.raw((`INSERT INTO SHAREHOLDERS(name,lastName,participation)
      VALUES(
      "${name}", 
      "${lastName}", 
      "${participation}", 
